...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>McGhost</code> &nbsp;·&nbsp; <code>mcghost</code>
</p>
...
Minecraft ghost client — combat modules, velocity, scaffold for PvP servers.

Ghost client is the term Hypixel players search, not a made-up brand.
...
```bash
dotnet restore minecraft-ghost-client.slnx
dotnet build minecraft-ghost-client.slnx -c Release
dotnet test minecraft-ghost-client.slnx -c Release
```
